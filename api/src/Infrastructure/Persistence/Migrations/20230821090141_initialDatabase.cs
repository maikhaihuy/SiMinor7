        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Views = table.Column<decimal>(type: "decimal(20,0)", nullable: true),
                    Rating = table.Column<long>(type: "bigint", nullable: true),
                    KeyTone = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TabArtists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TabArtists_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TabArtists_Tabs_TabId",
                        column: x => x.TabId,
                        principalTable: "Tabs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TabArtists_ArtistId",
                table: "TabArtists",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_TabArtists_TabId",
                table: "TabArtists",
                column: "TabId");

            migrationBuilder.CreateIndex(
                name: "IX_Tabs_GenreId",
                table: "Tabs",
                column: "GenreId");
        }
